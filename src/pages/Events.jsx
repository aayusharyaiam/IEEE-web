  ...
  return (
    <main className="pt-24 pb-20">
      ...
      <section ref={heroRef} className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 text-center relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-100 bg-[radial-gradient(circle_at_50%_0%,var(--color-secondary-container-val)_0%,transparent_70%)] opacity-30 -z-10 pointer-events-none"></div>
        <h1 className="events-hero-title text-[3.5rem] leading-[1.1] md:text-7xl font-bold tracking-tighter text-primary mb-6 uppercase perspective-midrange">EVENTS</h1>
      ...
      <section className="timeline-section max-w-7xl mx-auto px-6 py-12 relative">
        <div className="timeline-line absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-linear-to-b from-tertiary via-secondary/20 to-transparent hidden md:block origin-top" style={{ transformOrigin: 'top center' }}></div>
      ...
      <section className="newsletter-section mt-32 bg-surface-container-low py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 max-w-lg mx-auto">
            <input className="grow bg-surface-container-highest border-0 rounded-xl px-6 py-4 text-on-surface focus:ring-2 focus:ring-tertiary transition-all outline-none" placeholder="Your institutional email" type="email"/>
