  ...
  return (
    ...
    <main ref={pageRef} className="relative min-h-screen pt-24 pb-24 overflow-hidden" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, rgba(60, 215, 255, 0.05) 1px, transparent 0)', backgroundSize: '40px 40px' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <h1 className="contact-title text-5xl md:text-7xl font-bold tracking-tighter text-primary mb-4 uppercase perspective-midrange">GET IN TOUCH</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="contact-form flex flex-col space-y-8 opacity-0">
          <div className="bg-surface-container-low p-8 md:p-12 rounded-lg border border-outline-variant/10 shadow-xl relative mt-4 hover:shadow-[0_0_40px_rgba(60,215,255,0.08)] transition-shadow duration-500">
            <form className="space-y-10 group/form">
              ...
              <button type="submit" className="w-full group relative overflow-hidden bg-linear-to-r from-primary-container to-secondary-container py-4 rounded-xl font-bold text-on-surface tracking-tight hover:shadow-[0_0_20px_rgba(60,215,255,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all mt-4">
        ...
        <div className="contact-right flex flex-col space-y-8 mt-4">
          ...
          {/* Map Placeholder */}
          <a href="https://maps.app.goo.gl/GxnZsdpVK1A74P126" target="_blank" rel="noopener noreferrer" className="map-container relative w-full h-70 rounded-lg overflow-hidden group block cursor-pointer">
          ...
          <div className="info-grid grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a href="tel:+916122273615" className="info-card glass-panel p-6 rounded-lg border border-white/5 hover:border-tertiary/30 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-center group">
